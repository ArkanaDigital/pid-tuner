...
| `copter_4.4.2_auto_jitter.bin` | ArduCopter V4.4.2 (656c12a5) | 685,658 B (0.7 MB) | 47 s; IMU=1788, RATE/ATT=358 (~7.6 Hz), RCIN/RCOU=358. No PIDR/PIDP/PIDY, no batch IMU. Has three small corrupt regions (pymavlink skips ~54/60/52 bytes) - useful as a robustness case. | https://discuss.ardupilot.org/uploads/short-url/7WaMhWHgBrhAlEFFR58cI54dkbL.bin | ArduPilot Discourse, topic 108349 "Jitter in auto modes, help with log review", post 1 by user sherry142 (2023-10-26) - user-uploaded log, no explicit license |
